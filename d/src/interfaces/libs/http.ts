...
export interface HttpServiceResponseResult {
    data?: any;
    message?: any;
...
export type HttpServiceResponse = [Error & HttpServiceResponseResult, HttpServiceResponseResult];

/**
 * @see https://github.com/prettymuchbryce/http-status-codes/blob/master/index.d.ts
 */
export enum HttpStatusCode {
     ...
     * It is non-committal, meaning that there is no way in HTTP to later send an asynchronous response indicating the outcome
     * of processing the request. It is intended for cases where another process or server handles the request, or for batch processing.
     */
    ACCEPTED = 202,
    /**
     ...
     * use HTTP pre-connection mechanisms to speed up surfing. Also note that some servers merely shut down the connection
...
export declare class HttpService {
    ...
    get(options: RequestOptions, hostFingerprint?: string): Promise<HttpServiceResponse>;

    post(options: RequestOptions, hostFingerprint?: string, body?: any): Promise<HttpServiceResponse>;

    delete(options: RequestOptions, hostFingerprint?: string, body?: any): Promise<HttpServiceResponse>;

    put(options: RequestOptions, hostFingerprint?: string, body?: any): Promise<HttpServiceResponse>;
}

export interface PeerCertificateWithSHA256 extends PeerCertificate {
...
export interface MakeApiCallOps {
    method?: HttpMethod;
    data?: unknown;
}
